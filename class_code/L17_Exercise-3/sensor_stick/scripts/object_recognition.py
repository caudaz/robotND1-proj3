...
# Exercise-3 TODOs: 
    ...
    for index, pts_list in enumerate(cluster_indices):
        ...
        normed_features_color = compute_color_histograms(ros_cluster, using_hsv=True)
        normals = get_normals(ros_cluster)
        normed_features_norm  = compute_normal_histograms(normals)
        feature = np.concatenate((normed_features_color, normed_features_norm))
